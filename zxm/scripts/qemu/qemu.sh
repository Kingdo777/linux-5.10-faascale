...
net_scripts=$KERNEL_DIR/zxm/scripts/network
...
specific_qemu_args="-m 8G -smp 4 --enable-kvm -cpu host"
...
$QEMU_DIR/build/qemu-system-x86_64 \
  ...
  -append "noinintrd console=ttyS0 root=/dev/vda rw loglevel=8 nokaslr" \
